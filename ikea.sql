...
CREATE TABLE `carritosdecompras` (
  `idCarritosDeCompras` int NOT NULL AUTO_INCREMENT,
  `idUsuario` int NOT NULL,
  `idProducto` int NOT NULL,
  `cantidad` int NOT NULL,
  PRIMARY KEY (`idCarritosDeCompras`),
  KEY `carritos-usuarios_idx` (`idUsuario`),
  KEY `carritos-productos_idx` (`idProducto`),
  CONSTRAINT `carritos-productos` FOREIGN KEY (`idProducto`) REFERENCES `productos` (`idProductos`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `carritos-usuarios` FOREIGN KEY (`idUsuario`) REFERENCES `usuarios` (`idUsuarios`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `carritosdecompras` VALUES (1,1,1,1),(2,2,3,2),(3,3,4,1),(4,1,2,2),(5,2,1,1),(6,3,2,2);
...
CREATE TABLE `categoriasproductos` (
  `idCategoriasProductos` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ciudades` (
  ...
  CONSTRAINT `ciudades-paises` FOREIGN KEY (`idPaises`) REFERENCES `paises` (`idPaises`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `claseproductos` (
  `idClaseProductos` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) NOT NULL,
  `idCategoriasProductos` int NOT NULL,
  PRIMARY KEY (`idClaseProductos`),
  KEY `clase-categorias_idx` (`idCategoriasProductos`),
  CONSTRAINT `clase-categorias` FOREIGN KEY (`idCategoriasProductos`) REFERENCES `categoriasproductos` (`idCategoriasProductos`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `entregas` (
  ...
  CONSTRAINT `entregas-facturas` FOREIGN KEY (`idFacturas`) REFERENCES `facturas` (`idFacturas`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `existencias` (
  ...
  CONSTRAINT `existencias-productos` FOREIGN KEY (`idProductos`) REFERENCES `productos` (`idProductos`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `existencias-sucursales` FOREIGN KEY (`idSucursales`) REFERENCES `sucursales` (`idSucursales`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `facturas` (
  ...
  `fecha` date NOT NULL,
  `hora` time NOT NULL,
  `idCarritos` int NOT NULL,
  PRIMARY KEY (`idFacturas`),
  KEY `facturas-usuarios_idx` (`idUsuarios`),
  KEY `facturas-carritos_idx` (`idCarritos`),
  KEY `facturas-sucursales_idx` (`idSucursales`),
  CONSTRAINT `facturas-carritos` FOREIGN KEY (`idCarritos`) REFERENCES `carritosdecompras` (`idCarritosDeCompras`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `facturas-sucursales` FOREIGN KEY (`idSucursales`) REFERENCES `sucursales` (`idSucursales`),
  CONSTRAINT `facturas-usuarios` FOREIGN KEY (`idUsuarios`) REFERENCES `usuarios` (`idUsuarios`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `facturas` VALUES (1,1,'Efectivo',1,'2020-06-14','08:30:00',1),(2,2,'Efectivo',2,'2020-08-24','14:00:00',2),(3,3,'Efectivo',3,'2020-11-09','16:00:35',3),(4,1,'Tarjeta',4,'2020-04-02','08:45:22',4),(5,2,'Tarjeta',1,'2020-06-12','06:30:00',5),(6,3,'Tarjeta',5,'2020-09-24','22:30:00',6);
...
CREATE TABLE `productos` (
  ...
  CONSTRAINT `prodcutos-clase` FOREIGN KEY (`idClaseProductos`) REFERENCES `claseproductos` (`idClaseProductos`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sucursales` (
  ...
  CONSTRAINT `sucursales-ciudades` FOREIGN KEY (`idCiudades`) REFERENCES `ciudades` (`idCiudades`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `usuarios` VALUES (1,'pamelaabrego','Pamela','Abrego','Ramirez','7658-6598','Español','pamela@gmail.com','pamela1','San Salvador'),(2,'josesorto','Jose','Sorto','Rosales','7549-9246','Español','jose@gmail.com','jose1','San Miguel'),(3,'javierosorio','Javier','Osorio','Echeverria','7490-2486','Ingles','javier@gmail.com','javier1','San Salvador');
...
-- Dump completed on 2020-11-19 14:40:50
